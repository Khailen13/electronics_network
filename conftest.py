...
def contact_objects():
    ...
    for number in range(1, 4):
        contact_objects.append(Contact.objects.create(email=f"contact_{number}@mail.com", **contacts_same_data))
...
def product_objects():
    ...
    product_objects = []
    for number in range(1, 4):
        product_objects.append(Product.objects.create(name=f"Продукт_{number}", ** products_same_data))
